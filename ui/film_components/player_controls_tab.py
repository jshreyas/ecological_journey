        ...
        with self.container:
            with ui.column().classes('w-full h-full p-4 gap-4') as player_container_ref:
                ...
                if play_clips_playlist:
                    ...
                    VideoPlayer(self.video_state.video_id, speed=self.player_speed['value'], parent=player_container_ref)
    ...
    def play_clip(self, clip):
        ...
        if self.on_clip_play:
            ...
            if ref:
                ref.clear()
                with ref:
                    VideoPlayer(self.video_state.video_id, start=start_time, end=clip.get("end"), speed=speed, parent=ref)
